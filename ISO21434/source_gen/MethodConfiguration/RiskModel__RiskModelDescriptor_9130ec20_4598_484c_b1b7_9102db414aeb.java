...
public class RiskModel__RiskModelDescriptor_9130ec20_4598_484c_b1b7_9102db414aeb extends RiskModelDescriptor {

  public RiskModel__RiskModelDescriptor_9130ec20_4598_484c_b1b7_9102db414aeb(SNode riskModel) {
    super(riskModel);
    MapSequence.fromMap(_damageAggregators).put("Max", new IDamageAggregator() {
      ...
      public SNode aggregateDC(DCInfo damageCriteria) {
        return new ILMaxAggregator().aggregateIL(damageCriteria, _riskModel);
      }
    });
